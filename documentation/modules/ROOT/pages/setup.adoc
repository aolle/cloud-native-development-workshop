...
On this section, we will deploy all the components of the CI/CD environment. The environment is composed of a Gogs git server, a Sonatype Nexus, a SonarQube, a repository for test and project-generated reports and the Tekton pipelines.
...
----
git clone git@github.com:aolle/tekton-cd-demo.git
